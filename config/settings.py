...
# Minimum AI relevance score (0-100) a job must achieve before the bot applies.
# Jobs below this score are skipped. Set to 0 to disable score-based filtering.
# Hard rule: if experience gap > 2 years, job is ALWAYS skipped regardless of this threshold.
ai_score_threshold = 75             # 0 to 100
