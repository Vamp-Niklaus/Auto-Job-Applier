...
SCHEMA = [
    {
        ...
        "fields": [
            ...
            _f("Account", "settings", "ai_score_threshold", "AI score threshold (0–100)", "number",
               "Minimum relevance score a job must get before the bot applies. Jobs scoring below this are skipped. Set to 0 to disable. Hard rule: experience gap > 2 years always skips regardless of this value.",
               ai=True, advanced=True),
        ],
    },
    {
        ...
        "fields": [
            ...
            _f("Profile", "questions", "us_citizenship", "Citizenship status", "select",
               ...
               options=["U.S. Citizen/Permanent Resident", "Non-citizen allowed to work for any employer", "Non-citizen allowed to work for current employer", "Non-citizen seeking work authorization", "Canadian Citizen/Permanent Resident", "Indian Citizen", "Other"]),
    ...
    },
    {
        ...
        "fields": [
            ...
            _f("Search", "search", "apply_method", "Application Type / Method", "select",
               "Choose which types of job applications to submit.",
            ...
            _f("Search", "search", "salary", "Minimum salary", "select",
               ...
               options=["", "₹3,00,000+", "₹5,00,000+", "₹10,00,000+", "₹15,00,000+", "₹20,00,000+", "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"], advanced=True),
    ...
    },
    {
        "section": "My Resume",
        "fields": [
            _f("My Resume", "questions", "resume_text", "Resume content", "textarea",
               "Paste the full text of your resume here. The AI reads this to score how well you match each job posting. Jobs with an experience gap > 2 years are instantly skipped (no API call). Leave blank to disable AI scoring."),
        ],
    },
]
